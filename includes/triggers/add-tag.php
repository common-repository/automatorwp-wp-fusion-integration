...
class AutomatorWP_WP_Fusion_Add_Tag extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'Tag added to user', 'automatorwp-wp-fusion-integration' ),
            'select_option'     => __( '<strong>Tag</strong> added to user', 'automatorwp-wp-fusion-integration' ),
            /* translators: %1$s: Tag. %2$s: Number of times. */
            'edit_label'        => sprintf( __( '%1$s added to user %2$s time(s)', 'automatorwp-wp-fusion-integration' ), '{tag}', '{times}' ),
            /* translators: %1$s: Tag. */
            'log_label'         => sprintf( __( '%1$s added to user', 'automatorwp-wp-fusion-integration' ), '{tag}' ),
            ...
            'options'           => array(
                'tag' => array(
                    ...
                    'fields' => array(
                        'tag' => array(
                            'name' => __( 'Tag:', 'automatorwp-wp-fusion-integration' ),
                            'type' => 'select',
